...
(function () {
  ...
  var JsonReference = function () {
    function JsonReference(pointer) {
      _classCallCheck(this, JsonReference);

      this[$pointer] = pointer;
    }

    _createClass(JsonReference, [{
      key: 'resolve',
      ...
      if (typeT === 'object' && cursor.obj !== null) {
        if (Array.isArray(cursor.obj)) {
          ...
          while (++j < jlen) {
            ...
            if ((typeof it === 'undefined' ? 'undefined' : _typeof(it)) === 'object' && it !== null) {
  ...
  JsonPointer.list = function (target, fragmentId) {
    var res = [];
    var visitor = fragmentId ? function (ptr, val) {
      res.push({
